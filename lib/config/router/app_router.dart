...
final GlobalKey<NavigatorState> _popularsNavigatorKey =
    GlobalKey<NavigatorState>(debugLabel: 'tab-populars');
    ...
    routes: [
      StatefulShellRoute.indexedStack(
          ...
          branches: <StatefulShellBranch>[
            ...
            StatefulShellBranch(
                navigatorKey: _favoritesNavigatorKey, routes: [favoritesViewRoute()])
          ])
    ],
...
GoRoute homeViewOldRoute() {
  return GoRoute(path: "/movies", builder: (context, state) => const HomeView(), routes: [
    GoRoute(
      path: ":id",
      builder: (context, state) {
        final movieId = state.pathParameters['id'] ?? "no-id";
